        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="p-7 bg-white/70 backdrop-blur-sm border border-white/80 rounded-xl hover:bg-white hover:shadow-xl hover:shadow-black/5 transition-all duration-400">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-11 h-11 flex items-center justify-center bg-[#00488b]/10 rounded-lg">
                <Code className="w-5 h-5 text-[#00488b]" />
              </div>
            ...
            <ul className="space-y-2.5 mb-5">
              {projectBased.features.map((feature, index) => (
                <li key={index} className="flex items-start gap-3">
                  <Check size={16} className="text-[#00488b] mt-0.5 shrink-0" />
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-5 py-2.5 bg-[#00488b] text-white font-medium text-sm transition-all duration-400 hover:bg-[#003366] rounded-md"
            >
          ...
          {/* Agency Partner */}
          <div className="p-7 bg-white border-2 border-[#00488b] rounded-xl hover:shadow-xl hover:shadow-[#00488b]/10 transition-all duration-400">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-11 h-11 flex items-center justify-center bg-[#b80101]/10 rounded-lg">
                <Settings className="w-5 h-5 text-[#b80101]" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-[#222222]">
                  {agencyPartner.name}
            ...
            <ul className="space-y-2.5 mb-5">
              {agencyPartner.features.map((feature, index) => (
                <li key={index} className="flex items-start gap-3">
                  <Check size={16} className="text-[#b80101] mt-0.5 shrink-0" />
                  <span className="text-[#555555] text-sm">{feature}</span>
                </li>
              ))}
            </ul>
