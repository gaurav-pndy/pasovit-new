      ...
      <div className="max-w-350 mx-auto px-5 md:px-[7.6923%]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {guarantees.map((guarantee, index) => (
            <div
              key={index}
              className="p-8 border border-black/10 bg-white hover:border-[#00488b]/30 hover:shadow-lg transition-all duration-400 text-center group rounded-lg"
            >
              <div className="w-16 h-16 flex items-center justify-center bg-[#00488b]/10 mx-auto mb-6 group-hover:bg-[#00488b] transition-all duration-300 rounded-md">
                <Shield
                  size={28}
