        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="p-8 border border-black/10 bg-[#f8f9fa] rounded-lg hover:shadow-lg transition-all duration-400">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 flex items-center justify-center bg-blue/10 rounded-md">
            ...
            <ul className="space-y-3 mb-6">
              {projectBased.features.map((feature, index) => (
                <li key={index} className="flex items-start gap-3">
                  <Check size={18} className="text-blue mt-0.5 shrink-0" />
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-6 py-3 bg-blue text-white font-medium transition-all duration-400 hover:bg-[#003366] rounded-md"
            >
          ...
          {/* Agency Tech Partner */}
          <div className="p-8 border-2 border-blue bg-white rounded-lg hover:shadow-lg transition-all duration-400">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 flex items-center justify-center bg-red/10 rounded-md">
                <Settings className="w-6 h-6 text-red" />
              </div>
              <div>
                <h3 className="text-2xl font-bold text-[#222222]">
                  {agencyPartner.name}
            ...
            <ul className="space-y-3 mb-6">
              {agencyPartner.features.map((feature, index) => (
                <li key={index} className="flex items-start gap-3">
                  <Check size={18} className="text-red mt-0.5 shrink-0" />
                  <span className="text-[#555555] text-sm">{feature}</span>
                </li>
              ))}
            </ul>
