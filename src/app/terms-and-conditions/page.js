...
export const metadata = {
  ...
  description:
    "Read the terms and conditions of using Pasovit Technologies' website and services.",
  keywords: ["terms of use", "Pasovit terms and conditions", "website policy"],
  alternates: {
    canonical: "https://pasovit.com/terms-and-conditions",
  },
};
const terms = [
  {
...
const TermsOfUse = () => {
  return (
    <section className="py-16 md:py-24 mt-16 md:mt-24  bg-white border-b border-black/10">
